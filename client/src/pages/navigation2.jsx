// This was the naviagtion before adding state for the toggle button. Toggle didn't work here...no deployment yet though 2/5/24
...
export default function Navigation() {
  return (
<>
  <nav className="navbar navbarScroll fixed-top navbar-expand-lg bg-body-tertiary" data-bs-theme="dark" style={{borderBottom: '.1px solid #f0f0f0'}}>
   <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNav" style={{fontFamily: 'New Rocker, system-ui', fontSize: '1.6rem'}}>
      <ul className="navbar-nav">
        ...
        <li className="nav-item navbarScroll">
